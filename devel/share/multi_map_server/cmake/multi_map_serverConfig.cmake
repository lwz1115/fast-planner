...
if("TRUE" STREQUAL "TRUE")
  set(multi_map_server_SOURCE_PREFIX /root/catkin_ws/src/Fast-Planner/uav_simulator/Utils/multi_map_server)
  set(multi_map_server_DEVEL_PREFIX /root/catkin_ws/devel)
  ...
  set(multi_map_server_INSTALL_PREFIX /root/catkin_ws/install)
...
if(NOT "/root/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multi_map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/root/catkin_ws/src/Fast-Planner/uav_simulator/Utils/multi_map_server/${idir}'.  ${_report}")
    endif()
