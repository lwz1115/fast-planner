...
: ${AMENT_CURRENT_PREFIX:="/root/colcon_ws/install/so3_disturbance_generator"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/so3_disturbance_generator/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/so3_disturbance_generator/environment/path.sh"
